...
24. <em>is_integer_array()</em> or as getter method <em>isIntegerArray</em> - checks if the value property of the current validator instance is array of integers and sets answer property appropriately. The method is available for versions 3.x.x
