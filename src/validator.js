...
class validator {
    ...
    get show_warnings() { return this.#warnings; }
     ...
     */
    is_positive_integer() {
        return this.isInteger.And.is_equal_or_bigger_than(0);
    }
    /**
     ...
     * bigger than 0.
     */
    get isPositiveInteger() { return this.is_positive_integer(); }
    /**
     ...
     */
    is_negative_integer() { return this.isInteger.And.is_lesser_than(0); }
    /**
     ...
     *  
     */
    get isNegativeInteger() { return this.is_negative_integer(); }
    /**
     * @method is_float()
     * @returns {validator}
     ...
     */
    get isNegative() { return this.is_negative(); }
    /**
     * @method is_positive
     * @returns {validator}
     * @description this method tests if the
    ...
    is_positive() {
        ...
        return this.is_equal_or_bigger_than(0);
    }
    /**
     * @method isPositive
     * @returns {validator}
     ...
     * is positive number.
     */
    get isPositive() { return this.is_positive(); }
    /**
     ...
     */
    is_number_like() {
        this.#question = !Number.isNaN(this.value);
        return this.#set_answer();
    }
    /**
     * @method isNumberLike
     ...
     * be converted to number.
     */
    get isNumberLike() { return this.is_number_like(); }
    /**
    ...
    is_integer_like() {
        this.#question = typeof this.value === 'string' ?
            Number.isInteger(+this.copy().value)
     ...
     * @returns {validator}
     */
    get isIntegerLike() { return this.is_integer_like(); }
    /**
     ...
     * respectively.
     */
    is_string_array() { return this.isStringArray; }
    /**
     ...
     * validator instance to true or false respectively.
     */
    is_number_array() { return this.isNumberArray; }
    /**
    ...
    is_array_of_number_arrays_with_equal_size () { return this.isArrayOfNumberArraysWithEqualSize; }
    get isArrayOfNumberArraysWithEqualSize () {
        ...
        if (this.copy().isArray.answer) {
            ...
            if (is_first_item_array) {
                ...
                for (i = 0;i < n >> 2;i++) {
                    j = i << 2;
                    if (!new validator(this.value[j]).isNumberArray.And.has_length(m).answer) {
                        this.#question = false;
                        break;
                    }
                    ++j;
     ...
     */
    is_object() {
        this.#question = Object.prototype.toString.call(this.value) === '[object Object]';
        return this.#set_answer();
    }
    /**
     * @method isObject
     ...
     */
    is_function() {
        this.#question = this.value instanceof Function || typeof this.value === 'function'
        return this.#set_answer()
    }
    /**
     * @method isFunction
            ...
            new validator(elements).is_array()
                .on(true, () => {
                    this.#question = this.copy().for_all(item => {
                        return new validator(elements).for_any(element => element.is_same(item.value));
                    }).answer;
                }).on(false, () => this.#question = this.copy().for_any(item => item.is_same(elements)).answer);
        } else this.#question = false
        return this.#set_answer()
    }
    /**
