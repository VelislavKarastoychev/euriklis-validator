...
class validator {
    ...
    get isStringArray() {
        ...
        this.copy().isArray.on(true, () => {
            ...
            if (this._question && n % 4 >= 1 && this._question !== false) {
                j = n - 1;
                if (typeof this.value[j] !== 'string') this._question = false;
                else this._question = true;
            }
            if (this._question && n % 4 >= 2 && this._question !== false) {
                j = n - 2;
                if (typeof this.value[j] !== 'string') this._question = false;
                else this._question = true;
            }
            if (this._question && n % 4 >= 3 && this._question !== false) {
                j = n - 3;
                if (typeof this.value[j] !== 'string') this._question = false;
                else this._question = true;
            }
                ...
                .on(true, () => {
                    val.is_array()
                        .on(true, () => {
                            ...
                            if (val.value.length % 4 >= 1 && this._question !== false) {
                                i = val.value.length - 1;
                                item = new validator(val.value[i]);
                                if (callback(item, i).answer) this._question = true;
                                else this._question = false;
                            }
                            if (val.value.length % 4 >= 2 && this._question !== false) {
                                i = val.value.length - 2;
                                item = new validator(val.value[i]);
                                if (callback(item, i).answer) this._question = true;
                                else this._question = false;
                            }
                            if (val.value.length % 4 >= 3 && this._question !== false) {
                        ...
                        .on(false, () => {
                            ...
                            val.is_object().and()
                                ...
                                .on(true, () => {
                                    ...
                                    if (keys.length % 4 >= 1 && this._question !== false) {
                                        i = keys.length - 1;
                                        item = new validator(val.value[keys[i]]);
                                        if (callback(item, i).answer) this._question = true;
                                        else this._question = false;
                                    }
                                    if (keys.length % 4 >= 2 && this._question !== false) {
                                        i = keys.length - 2;
                                        item = new validator(val.value[keys[i]]);
                                        if (callback(item, i).answer) this._question = true;
                                        else this._question = false;
                                    }
                                    if (keys.length % 4 >= 3 && this._question !== false) {
                                        i = keys.length - 3;
                                        item = new validator(val.value[keys[i]]);
                                        if (callback(item, i).answer) this._question = true;
                                        else this._question = false;
    ...
    contains(elements) {
            ...
            if (this._question && eltype) {
                ...
                new validator(elements).is_array()
                    .on(true, () => {
                        this._question = this.copy().for_all(item => {
                            return new validator(elements).for_any(element => element.is_same(item.value));
                        }).answer;
                    }).on(false, () => this._question = this.copy().for_any(item => item.is_same(elements)).answer);
            } else this._question = false
            return this._set_answer_()
        }
        /**
                ...
                .on(true, () => {
                    new validator(this.value).is_array()
                        .on(true, () => {
                            ...
                            if (this.value.length % 4 >= 1 && !this._question) {
                            ...
                            if (this.value.length % 4 >= 2 && !this._question) {
                            ...
                            if (this.value.length % 4 >= 3 && !this._question) {
